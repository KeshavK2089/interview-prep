    ...
    <div className="mt-12 pt-10 border-t border-slate-100">
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h4 className="font-bold text-slate-900">Keshav K</h4>
            <p className="text-sm text-slate-500">Bioengineer</p>
          </div>
        </div>
        <div className="flex gap-3">
          <a href="mailto:keshavkotteswaran@gmail.com" className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50 transition-colors">
            <Mail size={16} /> Email
          </a>

export default async function handler(request, response) {
  ...
  const prompt = `
    ROLE: Master executive resume writer (Oxford/MIT standard).
    ...
    FORMAT: Experience header "Role | Company | Location | Date". Education header "Degree | School | Location | GPA | Date".
    TONE: High burstiness, impact verbs.
